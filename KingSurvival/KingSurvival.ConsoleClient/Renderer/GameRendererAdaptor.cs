namespace KingSurvival.ConsoleClient.Renderer
{
    ...
    /// <summary>
    /// The base class used to render images that implement the IRenderable interface. Uses TextRendererDecoratorBase implementation.
    /// <remarks>Adapter design pattern.</remarks>
    /// </summary>
    public class GameRendererAdaptor : IRenderer
    {
        ...
        {
            ClientValidator.CheckValueIsNull(textRendererDecorator, "Text renderer decorator for the game engine");
