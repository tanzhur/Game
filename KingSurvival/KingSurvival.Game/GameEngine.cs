namespace KingSurvival.Game
{
    ...
    public class GameEngine
    {
        ...
        /// </summary>
        private IList<IList<IPiece>> allPieces;
        ...
        public void StartGame()
        {
            ...
            while (this.gameIsRunning)
            {
                ...
                this.ProcessPlayerTurn(this.playerOneMoveLogic, GameConstants.Player1Turn);
                ...
                this.ProcessPlayerTurn(this.playerTwoMoveLogic, GameConstants.Player2Turn);
            }
        ...
        /// <summary>
        /// Generates all the objects needed by the game engine
        /// </summary>
        private void InitializeGameEngineObjects()
        {
            ...
            var initialMessageYCoordinate = this.initialGameBoardCoordinates.Y + this.gameBoard.Height + GameConstants.MessageToPlayerOffset;
            this.initialMessagesCoordinates = new Coordinate(this.initialGameBoardCoordinates.X, initialMessageYCoordinate);
        ...
        private void ProcessPlayerTurn(LogicPlayerPieceMoverBase playerLogic, string messageToPlayer)
        {
            // change the logic of the piece mover with the passed one
            this.pieceMover.PieceMoverStrategy = playerLogic;

            this.ProcessPlayerCommand(messageToPlayer);
        ...
        /// </summary>
        /// <param name="messageToShowToPlayer">Player specific message.</param>
        private void ProcessPlayerCommand(string messageToShowToPlayer)
        {
            while (true)
            {
                // ask for command
                this.ShowGameBoard();
                this.ShowMessageBellowGameBoard(messageToShowToPlayer);
